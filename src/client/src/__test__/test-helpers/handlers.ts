...
export const authHandlerException = rest.post(getLoginPath, async (req, res, ctx) => {
...
export const warehousesHandlerException = rest.get(getWarehousesPath, async (req, res, ctx) => {
...
export const warehouseCreationHandlerException = rest.post(
  getWarehouseCreationPath,
  async (req, res, ctx) => {
    return res(
      ctx.status(500),
      ctx.json({
...
export const handlers = [
  authUserHandler,
  filteredWarehousesHandler,
  warehousesHandler,
  warehousesDetailsHandler,
  warehouseCreationHandler,
  uploadImageHandler,
  warehouseCreationHandlerException,
]
